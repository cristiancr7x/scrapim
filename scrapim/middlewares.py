...
class URLCollectorMiddleware:
    def process_request(self, request, spider):
        # Registrar cada solicitud
        spider.logger.info(f"Solicitando URL: {request.url}")
        return None

    def process_response(self, request, response, spider):
        # Registrar el estado de la respuesta
        spider.logger.info(f"Estado de la respuesta para {request.url}: {response.status}")
        return response
